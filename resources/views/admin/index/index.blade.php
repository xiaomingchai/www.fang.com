    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            ...
            <dl id="menu-admin">
                ...
                <dt><i class="Hui-iconfont">&#xe62d;</i> {{$val['name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
                <dd>
                    <ul>
                        @foreach($val['sub'] as $item)
                            <li><a data-href="{{route($item['route_name'])}}" data-title="{{$item['name']}}" href="javascript:void(0)">{{$item['name']}}</a></li>
                        @endforeach
                    </ul>
                </dd>
                @endforeach
