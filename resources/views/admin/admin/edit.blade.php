@extends('admin.public.main')
    <title>修改用户 - 用户管理 - H-ui.admin v3.1</title>
    ...
    <form class="form form-horizontal" id="form-admin-add" action="{{route('admin.user.store')}}" method="post">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$row->username}}" placeholder="请输入用户名" id="username" name="username">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>实名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$row->truename}}" placeholder="请输入用户名" id="truename" name="truename">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="sex" type="radio" id="sex-1" value="先生" @if($row->sex=='先生') checked @endif>
                    <label for="sex-1">先生</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" name="sex" value="女士" @if($row->sex=='女士') checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$row->phone}}" placeholder="" id="phone" name="phone">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" placeholder="@" name="email" id="email" value="{{$row->email}}">
            </div>
        </div>
        <div class="row cl">
